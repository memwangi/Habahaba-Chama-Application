...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chama_id', models.UUIDField(default=uuid.uuid4, help_text='Unique ID for this particular chama across whole app')),
                ...
                ('members', models.ManyToManyField(blank=True, related_name='chama', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['groupName'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['chama'],
            },
